...
.NET MAUI, React and Python developer developer based in Colima, Mexico 🇲🇽. I build production apps with .NET MAUI and run several ventures on the side. I care about clean architecture, shipping real products, and building scalable income.
